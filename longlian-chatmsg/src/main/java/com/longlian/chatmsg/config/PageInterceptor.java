...
public class PageInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (mappedStatement.getId().matches(pageSqlId)) {
            ...
            if (parameterObject == null) {
                ...
                DataGridPage page = (DataGridPage) metaStatementHandler
                ...
                if(page.isCloseAutoSelectPageCount() == false){
                    // 重设分页参数里的总页数等
    ...
    /**
     * 从数据库里查询总的记录数并计算总页数，回写进分页参数<code>DataGridPage</code>,这样调用者就可用通过 分页参数
    ...
    private void setPageParameter(String sql, Connection connection, MappedStatement mappedStatement,
            BoundSql boundSql, DataGridPage page) {
        // 记录总记录数
     ...
     * @return
     */
    private String buildPageSql(String sql, DataGridPage page) {
        if (page != null) {
     ...
     * @return String
     */
    public StringBuilder buildPageSqlForMysql(String sql, DataGridPage page) {
        StringBuilder pageSql = new StringBuilder(100);
        String beginrow = String.valueOf((page.getCurrentPage() - 1) * page.getPageSize());
        if(page.getOffset() > 0){
            beginrow = page.getOffset() + "";//如果设置偏移量，就走偏移量
        }
        pageSql.append(sql);
     ...
     * @return String
     */
    public StringBuilder buildPageSqlForOracle(String sql, DataGridPage page) {
        StringBuilder pageSql = new StringBuilder(100);
        String beginrow = String.valueOf((page.getCurrentPage() - 1) * page.getPageSize());
