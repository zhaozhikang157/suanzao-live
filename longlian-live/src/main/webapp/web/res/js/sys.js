...
function bsWindow(url,title,opts){
    ...
    if(!window.BSWINDOW){
        ...
        window.BSWINDOW_BS6 = $("<div class=\"modal-body\" style=\"padding-top:0px;padding-bottom:0px;padding-top:3px;\"><center><img src=\"/web/res/image/loading1.gif\" /></center></div>");
