...
<head>
    ...
    <script src="${ctx}/web/res/fileupload/upload.js?nd=<%=current_version%>"></script>
    <script src="${ctx}/web/res/pc/js/singleEdit.js?nd=<%=current_version%>"></script>
    ...
    <script>
        var isPrivateCard='${isPrivateCard }';
        var id = ${id};
        var baseUrl = '${baseUrl}';
        var isUploading = false;
        /*  var seriesCourseName = "${seriesCourseName}";
         if(seriesCourseName != ""){

         $("#seriesCourse").show();
         $("#seriesCourseName").val('sdfsdf');
         }else{
         $("#seriesCourse").hide();
         }*/
        $(function () {
...
//        return false;
    ...
    <style>
        ...
        .lowbtn li:first-child{
            background: url("/web/res/image/picsmial.png") no-repeat 46px center;
            margin-right: 40px;
        }
        .lowbtn li:last-child {
            background: url("/web/res/image/textsmile.png") no-repeat 46px center;
            margin-right: 40px;
        }
...
<div style="margin-top:30px; " id="formDiv">
    <form class="form-horizontal form-horizontal-my-from" id="form1" name="myform" style="width: 94%"
        ...
        <div class="form-group" id="courseTypeDiv" style="">
        ...
        <div class="form-group" id="seriesCourse">
            <label for="liveTopic" class="col-sm-3 control-label"><span class="asterisk">* </span>系列课名称：</label>
            <div class="col-sm-6">
                <%--<input type="text" >--%>
                <div class="col-sm-5" id="seriesCourseName"style="padding-top: 7px;padding-left: 0" ></div>
            </div>
        </div>
        <div class="form-group" id="startTimeGroup">
            <label class="col-sm-3 control-label"><span class="asterisk">* </span>开课时间：</label>
        ...
        <div class="form-group" id="startTimeGroup2" style="display: none;">
            <label  class="col-sm-3 control-label"><span class="asterisk">* </span>开课时间：</label>
            <div class="col-sm-3" id="startTimeText" style="padding-top: 7px;">
        ...
        <div class="form-group"  hidden="hidden">
            ...
            <div class="col-sm-3">
                <select name="recTime" class="form-control sex" id="recTime">
                    <option value="0"></option>
                    <option  value="1800">0.5小时</option>
                    <option  value="3600">1.0小时</option>
                    <option  value="5400">1.5小时</option>
                    <option  value="7200">2.0小时</option>
                    <option  value="9000">2.5小时</option>
                    <option   value="10800">3.0小时</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group" style="margin-bottom: 20px">
            ...
            <div class="col-sm-6" style="color: #999">开课时间请选择当前时间之后的时间，直播时长请参考上传视频的时长</div>
        </div>
        ...
        <%-- 关闭课程编辑视频上传
                <div class="form-group" id="uploadVideoGroup">
                    ...
                    <div class="col-sm-6">
                        <div>
                            <div id="container">
                                ...
                                <div id="ossfile"></div>
                                <pre id="console"></pre>
                                <input type="hidden" check-type="required" name="videoAddress"  ng-model="course.modelUrl"   id="videoAddress"/>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group" id="uploadPrivateCard">
                        ...
                        <div style="float: left;width: 50%;" >
                                <a href="javascript:;" class="file" style="width: 30%;" >上传
                                    <input type="file" name="card_file" id="card_file" onchange="addCard(this)" />
                                </a>
...
<script  type="text/javascript" src="${ctx}/web/res/aliyunupload/lib/plupload-2.1.2/js/moxie.js"></script>
<script  type="text/javascript" src="${ctx}/web/res/aliyunupload/lib/plupload-2.1.2/js/plupload.dev.js"></script>
<script  type="text/javascript" src="${ctx}/web/res/aliyunupload/upload.js"></script>
</html>
