...
<head>
    ...
    <link rel="stylesheet" href="/web/res/pc/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="/web/res/pc/bootstrap-table/bootstrap-table.css">
    <script src="/web/res/jquery/jquery.min.js"></script>
    <script src="/web/res/pc/bootstrap/js/bootstrap.min.js"></script>
    <script src="/web/res/pc/bootstrap-table/bootstrap-table.js"></script>
    <script src="/web/res/pc/bootstrap-table/locale/bootstrap-table-zh-CN.js" ></script>
