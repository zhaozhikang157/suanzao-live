...
<body>
    ...
    <div class="default-main-layout indexleft">
      <ul class="indexnav">
        <li>
          <a class="on" href="javascript:void(0)" onclick="setFrame('${requestContext.contextPath}/wechat/welcome')">欢迎</a>
        </li>
       <%-- <   li>
          <a href="javascript:void(0)" onclick="setFrame('/wechat/bindinglive')">任务邀请卡设置</a>
        </li>--%>
        <li>
          <a href="javascript:void(0)" onclick="setFrame('${requestContext.contextPath}/wechat/bindinglive')">绑定直播间</a>
        </li>
        <li>
    ...
    <div  class="default-main-layout indexcon">
        <iframe name="myiframe" id="indexiframe" class="indexiframe" frameborder=0 src="${requestContext.contextPath}/wechat/welcome"></iframe>
    </div>
</body>
