...
$(function() {
	//$('#targetContentDiv').height($(window).innerHeight());
})
    </script>
	<style type="text/css">
...
#ContentDiv h1 {
	width:100%;
	height:120px;
	background:url(../staticResource/images/framelayout/403.png) no-repeat center center;
}
	...
	<div id="ContentDiv">
	  <div class="containers">
		...
		<ul>
		  ...
		  <li><a class="btn hover" href="${ctx}/j_spring_security_logout">注销</a></li>
		</ul>
      </div>
