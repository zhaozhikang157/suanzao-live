...
<div style="margin-top:10px; ">
    <form class="form-horizontal form-horizontal-my-from" id="form1" name="myform" style="" ng-controller="task">
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="userId" ng-model="mUser.userId" autocomplete="off" maxlength="50"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" id="name" name="name"
                       ng-model="mUser.name" autocomplete="off" placeholder="" maxlength="50">
            </div>
        </div>
