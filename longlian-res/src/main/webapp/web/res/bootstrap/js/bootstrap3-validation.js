...
!function($) {
   ...
   $.fn.validation.defaults = {
        validRules : [
            ...
            {name: 'phone', validate: function(value) {return ((!/^([0-9]{3,4}-)?[0-9]{7,8}$/.test(value)) && (!/^0?(13[0-9]|15[0-9]|17[01678]|18[0-9]|14[57])[0-9]{8}$/.test(value)));}, defaultMsg: '请输入正确的号码。'}//手机号和固定电话
        ],
        reqmark:true,
