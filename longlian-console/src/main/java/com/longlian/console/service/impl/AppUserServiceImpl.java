...
public class AppUserServiceImpl implements AppUserService {
    ...
    public Map membershiprebate(long id,Map mapRequest) {
        ...
        String beginTime = mapRequest.get("beginTime")+" 00:00:00";
        String endTime = mapRequest.get("endTime")+" 23:59:59";
        if(mapRequest!=null && mapRequest.get("beginTime")!=null && !"".equals(mapRequest.get("beginTime"))){
            mapRequest.put("beginTime",beginTime);
        }
        if(mapRequest!=null && mapRequest.get("endTime")!=null && !"".equals(mapRequest.get("endTime"))){
            mapRequest.put("endTime",endTime);
        }
    ...
    public int insertSystemAdmin(SystemAdmin admin) throws Exception{
        AppUser appUser=appUserMapper.findById(admin.getAdminId());
        if(appUser==null){
            return 0;
        }
        admin.setAdminName(appUser.getName());
