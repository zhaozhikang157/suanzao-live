...
<body>
<div class="container" style="width:97%;" ng-controller="task">
    ...
    <table class="table table-bordered tabBox">
        ...
        <tr align="center" ng-repeat="courseType in courseTypeList">
            <td class="sortBtnBox" dto_id="{{courseType.id}}" len="{{courseTypeList.length}}">
                {{courseType.id}}
                <%--{{courseType.orderSort}}--%>
            </td>
            <td>{{courseType.name}}</td>
          <%--  <td>{{courseType.remark}}</td>--%>
            <td>{{courseType.status}}</td>
           <%-- <td>
                <img style="max-width: 50px;max-height: 50px;" src="{{courseType.picAddress}}" />
            </td>--%>
            <td>{{courseType.orderSort}}</td>
            <td>
                <span><a href="javascript:void(0) " dto_id="{{courseType.id}}"
