...
<script>
    ...
    function doQueryDate() {
        ...
        $.ajax({
            ...
            async: false,
            dataType: 'json',
            url: "/dataStatistics/getExitRate",
            data:{
            ...
            success: function (obj) {
                if (obj.success) {
                    var option = myChart.getOption();
                        option.series[0].data = obj.data.exitRateMap.values;
                    option.xAxis[0].data = obj.data.exitRateMap.keys;
...
<script src="${requestContext.contextPath}/web/res/js/func/dataStatistics/exitRate.js"></script>
