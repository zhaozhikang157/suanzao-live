    ...
    <script>
        ...
        function doInit() {
            $('#table-bootstrap').bootstrapTable({
                ...
                url: "/ordersController/findIncomePage",
        ...
        function importExcel(){
            ...
            window.location.href = "/ordersController/importExcelIncome?appId="+param.appId+"&appMobile="+param.appMobile
            +"&startTime="+param.createTimeBegin+"&endTime="+param.createTimeEnd+"&bankType="+param.bankType;
        }
...
<div class="container" style="width:97%;margin-top:10px">
    ...
    <div id="toolbar">
        <form class="form-horizontal" id="form1" name="form1">
            ...
            <label>充值类型：</label>
            <select class="form-control" id="bankType" style="width: 180px;display: inline-block;">
                <option value="0">全部</option>
                <option value="13">微信</option>
                <option value="14">微信H5</option>
                <option value="15">IOS内购</option>
                <option value="17">微信H5_充值流量</option>
                <option value="18">APP_充值流量</option>
            </select>
