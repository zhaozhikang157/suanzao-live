                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        formatter: function (value, row) {
                            return [
                                '<a href="javascript:void(0)" onclick="getDetail(' + row.toAccountId + ');">' + '详情</a>'
                            ].join('');
                        }
                    }
                ]
            });
//            $(".shouru").text(sumIncome);
//            $(".zhichu").text(sumExpenditure);
            var css = { height: "94%"};
        ...
        function queryParams(params) {
            ...
            var appUserName = $("input[name='appUserName']").val();
        ...
        function getDetail(appId){
          ...
          /*  window.location.href="/accountTrack/showDetailed?appId="+appId+
            ...
            var title = "用户收支详情";
            //id:课程id
            var url = "/accountTrack/showDetailed?appId="+appId+
                    "&startTime="+$("#startTime").val()+"&endTime="+$("#endTime").val();
            bsWindow(url, title, {
        ...
        function importExcel(){
            ...
            window.location.href = "/accountTrack/importExcelBalanceOfPayments?toAccountId="+param.toAccountId+"&mobile="+param.mobile
...
<div class="container" style="width:97%;margin-top:10px">
    ...
    <div id="toolbar">
        <form class="form-horizontal" id="form1" name="form1">
            ...
            <label>用户昵称:</label>
            <input type="text" class="form-control" name="appUserName" autocomplete="off"
                       placeholder="" style="width: 60px;display: inline-block;">
            <label>手机号:</label>
