...
<div class="default-main-layout indextop">
    <div class="comLogo"><img alt="酸枣" title="酸枣" src="${requestContext.contextPath}/web/res/style/img/pic_wodezhuye.png" /></div>
    <div>|&nbsp;&nbsp;<span id="mobile"></span>&nbsp;&nbsp;你好，欢迎使用龙链酸枣直播后台管理系统&nbsp;&nbsp;&nbsp;</div>
    <ul>
...
<div  class="default-main-layout indexcon">
    <iframe name="myiframe" id="indexiframe" class="indexiframe" frameborder=0 src=""></iframe>
</div>
</body>
...
<script>
    ...
    function doInit(){
        ...
        $("#loginOut").click(function(){
            var jobx ;
            var option = {width:400,content:"欢迎您使用龙链酸枣直播后台管理系统<br>确定要退出吗？",confrimFunc:function(){
                jobx.close();
                logout();
            }
            };
