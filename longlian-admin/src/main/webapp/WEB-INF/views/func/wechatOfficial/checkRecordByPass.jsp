...
<head>
  ...
  <script >
      ...
      $('#table-bootstrap').bootstrapTable({
        ...
        columns: [
          ...
          },
          {
            ...
            formatter: function (value, row) {
              return [
                '<a href="javascript:void(0)" onclick="toEdit(' + row.id+ ');" >' + '修改</a>&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="updateManager(' + row.id+ ');" >' + '修改负责人</a>&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="unBindLiveRoom(' + row.id+ ');" >' + '解绑</a>&nbsp;&nbsp;&nbsp; <a href="javascript:void(0)" onclick="dataRecharge(' + row.id + ','+row.liveId+');" >' + '流量充值</a>'
              ].join('');
            }
          }]
      });
    ...
    function toEdit(aid) {
        var title = "编辑";
        var url = "/wechatOfficial/toEdit?id=" + aid;
        bsWindow(url, title, {
            height: 300, width: 700, buttons: []
        });
    }
