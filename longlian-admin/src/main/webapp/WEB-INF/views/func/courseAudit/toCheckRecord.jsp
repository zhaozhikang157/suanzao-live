...
<head>
  ...
  <script>
    ...
    function doInit(){
      $.addTab("tabs","tabs-content",{url:contextPath+"/courseAudit/toCheckRecordByAuditStatusPass",title:"已通过",active:true});
      $.addTab("tabs","tabs-content",{url:contextPath+"/courseAudit/toCheckRecordByAuditStatusNoPass",title:"未通过",active:false});
    }
