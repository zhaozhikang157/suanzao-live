    ...
    <script>
        function doInit() {
            $('#table-bootstrap').bootstrapTable({
                ...
                url: "/rewardRecord/getRecommendTeacherList",
        ...
        function getCountAccount() {
            ...
            $.ajax({
                type: "POST",
                url: "/rewardRecord/getRecommendTeacherAccount",
                data: str,
                async: false,
        ...
        function exportExcel() {
            ...
            var startAmount = $("#startAmount").val().trim();
            var endAmount = $("#endAmount").val().trim();
            window.location.href="/rewardRecord/exportExcelRecommendTeacher?recommendId="+recommendId+"&recommendName="+recommendName+"&startTime="+startTime+"&endTime="+endTime+"&startAmount="+startAmount+"&endAmount="+endAmount;
...
<div class="container" style="width:97%;margin-top:10px">
    ...
    <div id="toolbar">
        <form class="form-horizontal" id="form1" name="form1">
            ...
            <input type="text" class="form-control" name="recommendId" id="recommendId" autocomplete="off"
                   placeholder="用户ID"
                   placeholder="" style="width: 70px;display: inline-block;">

            <label class="control-label">用户名:</label>
            <input type="text" class="form-control" name="recommendName" id="recommendName" autocomplete="off"
                   placeholder="用户名"
