    ...
    <script>
        function doInit() {
            $('#table-bootstrap').bootstrapTable({
                ...
                url: "/rewardRecord/getCourseRecommendList",
        ...
        function getCountAccount(){
            ...
            $.ajax({
                type: "POST",
                url: "/rewardRecord/getCourseRecommendAccount",
                data: str,
                async: false,
        ...
        function exportExcel() {
            ...
            var startAmount = $("#startAmount").val().trim();
            var endAmount = $("#endAmount").val().trim();
            window.location.href="/rewardRecord/exportExcelCourseRewardRecord?appId="+appId+"&name="+name+"&startTime="+startTime+"&endTime="+endTime+"&startAmount="+startAmount+"&endAmount="+endAmount;
