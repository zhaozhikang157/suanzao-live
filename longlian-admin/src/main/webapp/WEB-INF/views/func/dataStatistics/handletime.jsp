...
<script>
    ...
    function doQueryDate() {
        ...
        $.ajax({
            ...
            async: false,
            dataType: 'json',
            url: "/dataStatistics/getPageHandleTime",
            data:{
            ...
            success: function (obj) {
                if (obj.success) {
                    ...
                    option.series[0].data = obj.data.keys;
                    option.xAxis[0].data = obj.data.values;
...
<script src="${requestContext.contextPath}/web/res/js/func/dataStatistics/handletime.js"></script>
