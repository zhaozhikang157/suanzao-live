...
<script>
    ...
    function doQueryDate() {
        ...
        $.ajax({
            ...
            async: false,
            dataType: 'json',
            url: "/dataStatistics/getStayLength",
            data:{
            ...
            success: function (obj) {
                if (obj.success) {
                    ...
                    option.series[0].data = obj.data.stayLengthMap.values;
                    option.xAxis[0].data = obj.data.stayLengthMap.keys;
...
<script src="${requestContext.contextPath}/web/res/js/func/dataStatistics/stayLength.js"></script>
