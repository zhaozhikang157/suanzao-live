...
<div>
    <div class="contact-tab" style="margin-top:30px; " >
        <form id="form3" class="form3" method="post" enctype="multipart/form-data" action="/avatar/uploadUrl">
            <div class="shade-box">本地上传</div>
            <span class="shade-text">文件格式为.zip</span>
            <input type="file" id="fileField" class="file-btn file" name="file" id="businessLicensePIC" value="本地上传" accept=".zip" />
            <p>
            *:图片为jpg格式!!!!!!
        </form>
    </div>
