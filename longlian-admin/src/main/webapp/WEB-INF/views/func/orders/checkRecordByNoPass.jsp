  ...
  <script >
    function doInit(){
      ...
      $('#table-bootstrap').bootstrapTable({
        ...
        url: "/ordersController/getCheckRecordList?auditStatus=2",   //auditStatus：审核状态 0-待审核 1-通过 2-不通过
    ...
    function exportExcel(){
      ...
      window.location.href="/ordersController/exportExcelBankOutCheckRecord?auditStatus=2&createTimeBegin="+createTimeBegin+"&createTimeEnd="+createTimeEnd+"&bankName="+bankName+"&orderNo="+orderNo+"&appMobile="+appMobile+"&optStatus="+optStatus+"&optStatusSrt="+optStatusSrt;
    }
  ...
  <div id="toolbar">
    <form class="form-horizontal" id="form1" name="form1">
      ...
      <input type="text" class="form-control" name="appMobile" autocomplete="off" placeholder="用户手机"
             placeholder="" style="width: 160px;display: inline-block;">
      <label>操作状态:</label>
      <select id="optStatus" class="form-control" style="display: inline-block;width: 100px;" name="optStatus">
        <option selected value="">全部</option>
