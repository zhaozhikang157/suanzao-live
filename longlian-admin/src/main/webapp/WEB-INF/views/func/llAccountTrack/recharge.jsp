    ...
    <script>
        ...
        function doInit() {
            $('#table-bootstrap').bootstrapTable({
                ...
                url: "/llAccountTrack/getRechargePage",
        ...
        function queryParams(params) {
            ...
            var bankType = $("#bankType option:selected").val();  //开户银行
        ...
        *   详情
        ...
        function findOrderInfo(id) {
            var title = "电子回单详情";
            var url = "/llAccountTrack/findOrderInfo?id=" + id ;
            bsWindow(url, title, {
        ...
        function exportExcel() {
            ...
            window.location.href = "/llAccountTrack/exportExcel?orderNo=" + orderNo +
                    "&bankType=" + bankType + "&startTime=" + startDate + "&endTime=" + endDate + "&appMobile=" + appMobile;
        }
    ...
    <div id="toolbar">
        <form class="form-horizontal" id="form1" name="form1">
            ...
            <input type="text" class="form-control" name="mobile" autocomplete="off" placeholder="用户手机"
                   placeholder="" style="width: 160px;display: inline-block;">
            <label>服务类型:</label>
            <select id="bankType" class="form-control" style="display: inline-block;width: 120px;" name="bankType">
                <option selected value="">全部</option>
                <option value="14">微信H5充值</option>
                <option value="13">微信</option>
                <option value="15">IOS充值</option>
            </select>
