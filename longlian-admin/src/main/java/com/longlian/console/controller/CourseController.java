...
public class CourseController {
    ...
    @RequestMapping(value = "/getCourseDataNum", method = RequestMethod.POST)
    @ResponseBody
    public ActResultDto getCourseDataNum(DataGridPage requestModel, @RequestParam Map map) {
        ActResultDto act = new ActResultDto();
        Map resMap= courseService.getCourseDataNum(map);
        act.setData(resMap);
        return act;
    }
    @RequestMapping(value = "/getCourseDataIncome", method = RequestMethod.POST)
    @ResponseBody
    public ActResultDto getCourseDataIncome(DataGridPage requestModel, @RequestParam Map map) {
        ActResultDto act = new ActResultDto();
        Map resMap= courseService.getCourseDatasIncome(map);
        act.setData(resMap);
        return act;
    }
    ...
    public void importExcel(HttpServletRequest req, HttpServletResponse response, String liveTopic,
                            ...
                            String isFree, Date startDate,Date endDate,
