...
import com.longlian.console.dao.res.MResRelvMapper;
import com.longlian.console.dao.res.MUservMapper;
import com.longlian.console.service.res.MResService;
...
public class MResServiceImpl implements MResService{
    ...
    @Autowired
    MResvMapper mResMapper;
    @Autowired
    MResRelvMapper mResRelMapper;
    @Autowired
    MUservMapper mUserMapper;
