...
public interface CourseMapper {
    ...
    List<Map> getButtonDatasBListPage(@Param("page") DatagridRequestModel requestModel, @Param("map") Map map);  //课程按钮 关联数据统计
    ...
    List<Map> getCourseDataIncome(@Param("map") Map map);
    List<Map> getCourseDataNum(@Param("map") Map map);
