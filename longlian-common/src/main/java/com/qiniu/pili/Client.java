...
public final class Client {
    ...
    public void updateConverts(String hub,String key) throws Exception{
        /*String[] strs = {"480p","720p"};
        StreamInfo str = new StreamInfo(hub,key);//创建直播空间和对应流对象
        Stream s = new Stream(str,cli);
        s.updateConverts(strs);*/
        Convert.updateConvert(mac,hub,key);
    }
