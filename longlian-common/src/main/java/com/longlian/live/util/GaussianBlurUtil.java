...
/**
 * Created by liuhan on 2017-07-19.
 */
...
public class GaussianBlurUtil {
    ...
    public static void main(String[] args) throws IOException {
        BufferedImage img = ImageIO.read(new File("d:\\bbb.jpg"));
        long start = System.currentTimeMillis();

        int radius = img.getWidth()/100;
        img = blur(img, radius);
        long end = System.currentTimeMillis();
        ImageIO.write(img, "jpeg", new File("d:\\11.jpg"));//保存为test.jpeg文件
