 ...
 */
@Service
public class StudyCountProcess extends LongLianProcess{
    @Autowired
    ...
    private Logger logg= LoggerFactory.getLogger(StudyCountProcess.class);

    @Override
    public void addThread() {
         GetData t1 = new GetData(this, redisUtil , RedisKey.ll_visit_count_wait2db);
    ...
    private class GetData extends DataRunner{
        ...
        public void process(String msg) throws Exception {
            ...
            long count =  studyRecordService.getCountByCourseId(courseId);
