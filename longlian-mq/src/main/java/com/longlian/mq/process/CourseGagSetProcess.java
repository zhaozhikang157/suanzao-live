 ...
 */
@Service
public class CourseGagSetProcess extends LongLianProcess{
    private static Logger log = LoggerFactory.getLogger(CourseGagSetProcess.class);
    ...
    public void addThread() {
        GetData t1 = new GetData(this, redisUtil , RedisKey.ll_set_user_gag_wait2db);
    ...
    private class GetData extends DataRunner {
        ...
        public void process(String msg) throws Exception {
            ...
            if(gag != null){
                int i = gagService.findSameUserId(gag);
                if(i < 1){
                    gagService.setGagMq(gag);
