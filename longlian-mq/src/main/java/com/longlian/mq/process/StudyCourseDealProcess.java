 ...
 */
@Service
public class StudyCourseDealProcess extends LongLianProcess{
    @Autowired
    ...
    private Logger logg= LoggerFactory.getLogger(StudyCourseDealProcess.class);

    @Override
    public void addThread() {
         GetData t1 = new GetData(this, redisUtil , RedisKey.ll_course_visit_user_deal);
